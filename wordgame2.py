...
class Word:
    ...
    def guessed(self, guesses):
        ...
        if letters_guessed == self.letters_in_word:
            ...
            return ("\n You are incorrect!!")      
    def score(self):
        self.score_count = self.guesses_made
        print(self.guesses_made)
...
class Game:
    ...
    def display_score(self, guesses):
        print("\n", self.guesses_made(guesses))
        print("\nUsed: \n", guesses.made())
    ...
    def play_game(self):
        ...
        while True:
            ...
            self.display_score(guesses)
            if target.guessed(guesses):
                print("\nYou win!!!")
            else:
                print("\nYou Lose!! Word Reveal:", target.word)
                break
